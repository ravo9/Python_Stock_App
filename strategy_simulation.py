...
def fetch_necessary_data_for_experiment(companies):
    ...
    save_fetched_data_into_database_share_prices(
        fetch_share_prices_from_yahoo_finance_api(
            companies,
...
def run_multiple_period_simulation(companies, start_date, end_date, attribute_of_decision_index, whole_period_length, period_length_in_days, set_name = None, debug_mode = False):
    ...
    for sub_period in sub_period_dates:
        ...
        investment_change_in_this_sub_period = calculate_change_for_bets_made_for_given_companies_in_particular_period(sub_period_weights, is_it_last_sub_period, sub_period[0], sub_period[1], debug_mode)
    ...
    average_change = calculate_average_change_for_given_companies_in_particular_period(companies, start_date, end_date, debug_mode)
