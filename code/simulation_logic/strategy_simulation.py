from .calculation_utils import calculate_investment_value_change, calculate_average_share_price_change, calculate_weights
...
def run_simulation(companies, start_date, end_date, period_length_in_days, number_of_reports_for_calculation):
    ...
    change_in_value_of_money_invested_equally = calculate_average_share_price_change(companies, start_date, end_date)
    ...
    change_in_value_of_money_invested_by_using_tested_strategy = _test_strategy(companies, start_date, end_date, period_length_in_days, number_of_reports_for_calculation)
...
def _test_strategy(companies, start_date, end_date, period_length_in_days, number_of_reports_for_calculation, original_money = 1000):
